...
//         },
//         videoData = [],
//         maxSize = 1024000,// 50Mb, 52428800
//         interval = 1000,
//         video = document.getElementById('video-record'),
//         btnStart = document.getElementById('play'),
//         btnStop = document.getElementById('stop'),
//         container = document.getElementById("video-record-download")
//
// //
// function isValid(){
//
...
//
// //
// function btnChange(isPlay = true) {
//     if(isPlay){
...
// //
// function sizeValid(){
//     if(size < maxSize && size >= maxSize*0.9){
...
// function stop(){
//
//     if(mediaRecord !== undefined && mediaRecord.state === "recording") {
//
//         mediaRecord.stop()
//
...
//     }
//
//     container.insertAdjacentElement("beforeend", recordedMedia)
//     container.insertAdjacentElement("beforeend", downloadButton)
//
// }
//
// //
...
//
//     if(isValid() && await initMedia(video)){
//
...
//
//         timeoutTrack = setInterval(function () {
//             updateTrack()
//         }, interval)
//
//         btnChange()
